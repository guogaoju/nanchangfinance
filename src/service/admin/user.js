...
module.exports = class extends CMPage {
    ...
    async pageSave(parms) {
        ...
        // ]);
        let md = cmpage.objPropertysFromOtherObj({}, parms, ['c_name', 'c_sex', 'c_phone', 'c_email', 'c_qq', 'c_address', 'c_memo', 'c_dept',
            'c_user', 'c_time', 'c_group', 'c_manager'
        ]);
