...
exports.objPropertysReplaceToStr = function (str, obj) {
    // console.log("---------------objPropertysReplaceToStr--------------------");
...
exports.checkMobile = function (agent) {
    var flag = false;
    ...
    if (!(agent.indexOf("windows nt") > -1) || agent.indexOf("windows nt") > -1 && agent.indexOf("compatible; msie 9.0;") > -1) {
        ...
        if (!(agent.indexOf("windows nt") > -1) && !agent.indexOf("macintosh") > -1 && !(agent.indexOf("ipad") > -1)) {
            for (var _iterator6 = keywords, _isArray6 = Array.isArray(_iterator6), _i6 = 0, _iterator6 = _isArray6 ? _iterator6 : (0, _getIterator3.default)(_iterator6);;) {
                var _ref11;
